...
export default function productDetailsSingleSlide() {
  return (
    <>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        <h3 className="breadcrumb-title">Product Details - Single Slide</h3>
                        <div className="breadcrumb-nav breadcrumb-nav-color--black breadcrumb-nav-hover-color--golden">
                            <nav aria-label="breadcrumb">
                                <ul>
                                    <li><a href="index.html">Home</a></li>
                                    <li><a href="shop-grid-sidebar-left.html">Shop</a></li>
                                    <li className="active" aria-current="page">Product Details Single Slide</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
    ...
    <div className="product-details-section section-fluid">
        <div className="container">
            <div className="row">
                <div className="col-12">
                    <div className="product-details-gallery-area mb-7" data-aos="fade-up" data-aos-delay="0">
                        {/*<!-- Start Large Image -->*/}
                        <div className="default-slider-nav-arrow">
                            <div className="product-large-image product-image-single-slide swiper-container">
                            ...
                            <div className="single-slide swiper-button-prev"></div>
                            <div className="single-slide swiper-button-next"></div>
                        </div>

...
export default function productDetailsStickyRight() {
  return (
    <>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        <h3 className="breadcrumb-title">Product Details - Sticky Right</h3>
                        <div className="breadcrumb-nav breadcrumb-nav-color--black breadcrumb-nav-hover-color--golden">
                            <nav aria-label="breadcrumb">
                                <ul>
                                    <li><a href="index.html">Home</a></li>
                                    <li><a href="shop-grid-sidebar-left.html">Shop</a></li>
                                    <li className="active" aria-current="page">Product Details Sticky Right</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
            ...
            <div className="row flex-row-reverse">
                <div className="col-xl-5 col-lg-6">
                    <div className="product-details-gallery-area clearfix" data-aos="fade-up" data-aos-delay="0">
                        <div className="product-large-image product-large-image-style-sticky">
                            <div className="product-image-sticky-single">
                ...
                <div className="col-xl-7 col-lg-6">
                    <div className="product-details-content-area product-details-content-area-sticky product-details--golden"

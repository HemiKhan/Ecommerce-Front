...
export default function productDetailsGalleryLeft() {
  return (
   <>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        <h3 className="breadcrumb-title">Product Details - Gallery Left</h3>
                        <div className="breadcrumb-nav breadcrumb-nav-color--black breadcrumb-nav-hover-color--golden">
                            <nav aria-label="breadcrumb">
                                <ul>
                                    <li><a href="index.html">Home</a></li>
                                    <li><a href="shop-grid-sidebar-left.html">Shop</a></li>
                                    <li className="active" aria-current="page">Product Details Gallery Left</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
            ...
            <div className="row">
                <div className="col-xl-5 col-lg-6">
                    <div className="product-details-gallery-area clearfix">
                        <div className="product-large-image product-large-image-style-gallery clearfix" data-aos="fade-up"
                            data-aos-delay="0">

...
export default function productDetailsTabRight() {
  return (
   <>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        <h3 className="breadcrumb-title">Product Details - Tab Right</h3>
                        <div className="breadcrumb-nav breadcrumb-nav-color--black breadcrumb-nav-hover-color--golden">
                            <nav aria-label="breadcrumb">
                                <ul>
                                    <li><a href="index.html">Home</a></li>
                                    <li><a href="shop-grid-sidebar-left.html">Shop</a></li>
                                    <li className="active" aria-current="page">Product Details Tab Right</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
        ...
        <div className="container">
            <div className="row">
                <div className="col-xl-5 col-lg-6">
                    <div className="product-details-gallery-area product-details-gallery-area-vartical product-details-gallery-area-vartical-right"
                        data-aos="fade-up" data-aos-delay="0">
                        {/*<!-- Start Large Image -->*/}
                        <div className="product-large-image product-large-image-vartical swiper-container mr-5">
                        ...
                        <div className="product-image-thumb product-image-thumb-vartical swiper-container pos-relative">
                            <div className="swiper-wrapper">

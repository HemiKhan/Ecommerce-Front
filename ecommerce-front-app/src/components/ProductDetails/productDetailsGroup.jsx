...
export default function productDetailsGroup() {
  return (
   <>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        <h3 className="breadcrumb-title">Product Details - Group</h3>
                        <div className="breadcrumb-nav breadcrumb-nav-color--black breadcrumb-nav-hover-color--golden">
                            <nav aria-label="breadcrumb">
                                <ul>
                                    <li><a href="index.html">Home</a></li>
                                    <li><a href="shop-grid-sidebar-left.html">Shop</a></li>
                                    <li className="active" aria-current="page">Product Details Group</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div className="product-details-content-area product-details--golden" data-aos="fade-up"
                        ...
                        <div className="product-details-variable">
                            ...
                            <div className="variable-single-item">
                                ...
                                <div className="product-variable-group table-responsive ">
                                    <table className="table table-bordered">
                                        <tbody>
                                            <tr className="tr-vertical-middle">
                                                <td>
                                                ...
                                                <td>
                                                    <a href="product-details-default.html" className="link--gray">Kaoreet
                                                        lobortis sagit</a>
                                                </td>
                                                <td>
                                                    <div className="product-price">
                                                        <span className="product-price-reg">$31.69</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div className="product-stock">
                                                        <span className="product-stock-in"><i
                                                                className="fa fa-check-circle"></i> </span>9 IN STOCK
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr className="tr-vertical-middle">

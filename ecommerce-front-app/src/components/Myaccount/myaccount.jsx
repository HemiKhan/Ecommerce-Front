                    ...
                    <div className="dashboard_tab_button" data-aos="fade-up" data-aos-delay="0">
                        <ul role="tablist" className="nav flex-column dashboard-list">
                            <li><a href="#dashboard" data-bs-toggle="tab"
                                    className="nav-link btn btn-block btn-md btn-black-default-hover active">Dashboard</a>
                            </li>
                            ...
                            <li><a href="#downloads" data-bs-toggle="tab"
                                    className="nav-link btn btn-block btn-md btn-black-default-hover">Downloads</a></li>
                            ...
                            <li><a href="login.html"
                                    className="nav-link btn btn-block btn-md btn-black-default-hover">logout</a></li>
                        </ul>
                    </div>
                </div>

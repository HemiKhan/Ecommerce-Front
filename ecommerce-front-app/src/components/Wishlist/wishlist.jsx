                            ...
                            <div className="table_page table-responsive">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td className="product_remove"><a href="/"><i className="fa fa-trash-o"></i></a>
                                            </td>
                                            <td className="product_thumb"><a href="product-details-default.html"><img
                                                        src="assets/images/product/default/home-1/default-1.jpg"
                                                        alt="" /></a></td>
                                            <td className="product_name"><a href="product-details-default.html">Handbag
                                                    fringilla</a></td>
                                            <td className="product-price">$65.00</td>
                                            <td className="product_stock">In Stock</td>
                                            <td className="product_addcart"><a href="/" className="btn btn-md btn-golden"
                                        ...
                                        <tr>
                                            ...
                                            <td className="product_thumb"><a href="product-details-default.html"><img
                                                        ...
                                                        alt="" /></a></td>
                                            <td className="product_name"><a href="product-details-default.html">Handbags
                                                    justo</a></td>

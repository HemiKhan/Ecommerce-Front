                ...
                <div className="col-12">
                    <div className="user-actions accordion" data-aos="fade-up" data-aos-delay="0">
                        <h3>
                            ...
                            Returning customer?
                            <a className="Returning" href="/" data-bs-toggle="collapse" data-bs-target="#checkout_login"
                    ...
                    <div className="user-actions accordion" data-aos="fade-up" data-aos-delay="200">
                        <h3>
                            <i className="fa fa-file-o" aria-hidden="true"></i>
                            Returning customer?
                            <a className="Returning" href="/" data-bs-toggle="collapse" data-bs-target="#checkout_coupon"

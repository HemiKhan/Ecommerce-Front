                        ...
                        <div className="breadcrumb-nav breadcrumb-nav-color--black breadcrumb-nav-hover-color--golden">
                            <nav aria-label="breadcrumb">
                                <ul>
                                    ...
                                    <li className="active" aria-current="page">Frequently Asked Questions</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
            ...
            <div className="row">
                <div className="col-12">
                    <div className="faq-content" data-aos="fade-up" data-aos-delay="0">
                        <h5 className="title">Below are frequently asked questions, you may find the answer for yourself
                        </h5>
